		...
		<html lang="{$getLanguageCode()}">
			...
			<div class="container">
				...
				<div class="jumbotron">
					...
					<p style="font-size: 70%; line-height: 1;">The following are resources for the Miraheze wiki-farm which hosts 5,500+ wikis, not specific to a single wiki's community. Do not request topic-specific help there as we are not able to assist.</p>
					<p>
