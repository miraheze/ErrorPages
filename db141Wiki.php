	...
	echo <<<EOF
		...
		<html lang="{$getLanguageCode()}">
			<head>
				...
				<title>{$getTranslation( 'db141-wiki-temporarily-unavailable-title' )}</title>
				<!-- Bootstrap core CSS -->
			...
			<div class="container">
				...
				<div class="jumbotron">
					...
					<h1>{$getTranslation( 'db141-wiki-temporarily-unavailable-title' )}</h1>
					<p class="lead">{$getTranslation( 'db141-wiki-temporarily-unavailable' )}</p>
					<p>{$getTranslation( 'db141-wiki-temporarily-unavailable-more' )}</p>
					<p>
						<a href="https://discord.gg/TVAJTE4CUn" class="btn btn-lg btn-outline-primary" role="button">{$getTranslation( 'db141-join-discord' )}</a>
						<a href="https://meta.miraheze.org/wiki/Tech:SRE_noticeboard" class="btn btn-lg btn-outline-primary" role="button">{$getTranslation( 'db141-learn-more' )}</a>
					</p>
				</div>
				<div class="body-content">
					<div class="row">
						<div class="col-md-6">
							<h2>{$getTranslation( 'db141-what-happened' )}</h2>
							<p>{$getTranslation( 'db141-what-happened-more' )}</p>
						</div>

						<div class="col-md-6">
							<a class="twitter-timeline" data-width="500" data-height="350" href="https://twitter.com/MirahezeStatus?ref_src=twsrc%5Etfw">{$getTranslation( 'db141-find-updates-on-twitter' )}</a>
