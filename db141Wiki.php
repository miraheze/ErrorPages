		...
		<html lang="{$getLanguageCode()}">
			...
			<div class="container">
				...
				<div class="jumbotron">
					...
					<h1>Wiki Temporarily Unavailable</h1>
					<p class="lead">The Miraheze wiki that you are trying to access is temporarily unavailable.</p>
					<p>You can join the Miraheze Discord server or find updates on Twitter for for more information.</p>
					<p>
						<a href="https://discord.gg/TVAJTE4CUn" class="btn btn-lg btn-outline-primary" role="button">Join Miraheze Discord Server</a>
						<a href="https://meta.miraheze.org/wiki/Tech:SRE_noticeboard" class="btn btn-lg btn-outline-primary" role="button">Learn more on Miraheze Meta</a>
					</p>
				</div>
				<div class="body-content">
					<div class="row">
						<div class="col-md-6">
							<h2>What happened?</h2>
							<p>Some of the disks on one of the database servers on Miraheze, the platform that hosts this wiki, had some issues that caused the entire database server and all wikis on it to go down. We are working hard on fixing this issue, but unfortunately we do not have an ETA at this time, for when this wiki will be back online. We apologise for the inconvenience. You can join our Discord server with the above link or follow our Twitter updates (<a href="https://twitter.com/miraheze">@miraheze</a> or <a href="https://twitter.com/MirahezeStatus">@MirahezeStatus</a>) for more information and live updates as we have them.</p>
						</div>

						<div class="col-md-6">
							<a class="twitter-timeline" data-width="500" data-height="350" href="https://twitter.com/MirahezeStatus?ref_src=twsrc%5Etfw">Find Updates on Twitter</a>
