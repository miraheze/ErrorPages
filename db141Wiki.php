		...
		<html lang="{$getLanguageCode()}">
			...
			<div class="container">
				...
				<div class="jumbotron">
					...
					<p class="lead">The wiki you are trying to access is currently unavailable due to a database outage.</p>
					<p>The wiki you are trying to access is currently unavailable due to a database outage. You can join the Miraheze Discord server or find updates on Twitter for for more information.</p>
					<p>
