		...
		<html lang="{$getLanguageCode()}">
			...
			<div class="container">
				...
				<div class="jumbotron">
					...
					<p class="lead">Please check our Twitter feed below or join #miraheze-sre on irc.libera.chat or our <a href="https://discord.gg/TVAJTE4CUn">Discord server</a> for more updates. We are very sorry for this inconvenience.</p>
					<p>
						<a href="https://twitter.com/MirahezeStatus" class="btn btn-lg btn-outline-primary" role="button">Find updates on Twitter</a>
						<a href="https://discord.gg/TVAJTE4CUn" class="btn btn-lg btn-outline-primary" role="button">Join Discord</a>
					</p>
				</div>
			</div>
