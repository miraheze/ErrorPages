		...
		<html lang="{$getLanguageCode()}">
			...
			<div class="container">
				...
				<div class="jumbotron">
					...
					<p class="lead">This wiki is temporarily unavailable due to a database server issue. We are working to restore this wiki.</p>
					<p style="font-size: 70%; line-height: 1;">The following are resources for the Miraheze wiki-farm which hosts 5,500+ wikis, not specific to a single wiki's community. Do not request game/topic-specific help there as we are not able to assist.</p>
					<p>
						<a href="https://meta.miraheze.org/wiki/Tech:SRE_noticeboard" class="btn btn-lg btn-outline-primary" role="button">Learn more</a>
						<a href="https://twitter.com/MirahezeStatus" class="btn btn-lg btn-outline-primary" role="button">Twitter updates</a>
						<a href="https://discord.gg/TVAJTE4CUn" class="btn btn-lg btn-outline-primary" role="button">Miraheze Discord</a>
					</p>
				</div>
			</div>
